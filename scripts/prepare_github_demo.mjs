...
const summary = {
  ...
  purpose:
    "A structured design reference library for AI agents that need stable visual direction when generating websites and slide decks.",
  solves: [
...
<body>
  <main>
    <header>
      ...
      <p class="lede">一个给 AI 设计代理使用的网页/PPT 审美参考库。它把优秀网页和演示稿整理成分类、标签、预览和兼容性规则，让 AI 生成网页、产品页或演示稿时有稳定参考，而不是随机堆卡片、渐变和装饰。</p>
    </header>
